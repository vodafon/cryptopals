...
func (obj *User) SendPG() {
	obj.receiver.ReceivePG(obj.dh.P, obj.dh.G)
}

func (obj *User) ReceivePG(p, g *big.Int) {
	obj.dh.Change(p, g)
}

func (obj *User) SendACK() {
	obj.receiver.ReceiveACK()
}

func (obj *User) ReceiveACK() {
	obj.SendK()
}
